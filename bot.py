...
async def on_message(message):
    ...
    # Start of provided code block

# Define the phrases to respond to
good_morning_responses = [
    "Good morning! Have a great day!",
    "Good morning! Wishing you a fantastic day ahead!",
    "Good morning! Hope you have a wonderful day!",
    "Good morning! Make today amazing!",
    "Good morning! Enjoy your day!"
]

good_afternoon_responses = [
...
good_evening_responses = [
    ...
    "Good evening! Have a pleasant evening!"
]
...
responses = {
    "good morning": good_morning_responses,
    "good afternoon": good_afternoon_responses,
    "good evening": good_evening_responses,
    "good night": good_night_responses,
    "hello": hello_responses,
    "thank you": thank_you_responses
}


    # Check if the message content matches any of the phrases
    msg_content = message.content.lower()
    if msg_content in responses:
        response = random.choice(responses[msg_content])
