...
elif message.content.lower().startswith(("weapon atk food buff", "weapon atk buff")):
    embed = discord.Embed(
        title='Weapon ATK Food Buff Codes',
        description='''
1. Code: 1010029 LVL 10
2. Code: 1010099 LVL 10
3. Code: 6010024 LVL 10
4. Code: 1011126 LVL 10
5. Code: 3070028 LVL 9
        ''',
        color=discord.Color.green()
    )
    await message.channel.send(embed=embed)
    ...
    embed = discord.Embed(
        ...
        description='''
1. Code: 4016699 LVL 10
2. Code: 7070777 LVL 10
3. Code: 6240980 LVL 9
4. Address: Elscaro-A-1 LVL 9
        ''',
        color=discord.Color.green()
    )
    await message.channel.send(embed=embed)
    ...
    embed = discord.Embed(
        ...
        description='''
1. Code: 1010058 LVL 10
2. Code: 6140110 LVL 9
3. Code: 1234567 LVL 9
4. Code: 4204200 LVL 8
5. Code: 1050051 LVL 8
6. Code: 3011143 LVL 8
        ''',
        color=discord.Color.green()
    )
    await message.channel.send(embed=embed)
    ...
    embed = discord.Embed(
        ...
        description='''
1. Code: 6010701 LVL 10
2. Address: Elscaro-z-1234 LVL 8
        ''',
        color=discord.Color.green()
    )
    await message.channel.send(embed=embed)
    ...
    embed = discord.Embed(
        ...
        description='''
1. Code: 7162029 LVL 10
2. Code: 4010228 LVL 8
3. Code: 1010050 LVL 8
        ''',
        color=discord.Color.green()
    )
    await message.channel.send(embed=embed)
    ...
    embed = discord.Embed(
        ...
        description='''
1. Code: 1012144 LVL 8
2. Code: 1010000 LVL 8
        ''',
        color=discord.Color.green()
    )
    await message.channel.send(embed=embed)

elif message.content.lower().startswith(("accuracy food buff", "accuracy buff")):
    embed = discord.Embed(
        title='Accuracy Food Buff Codes',
        description='''
1. Code: 1010013 LVL 9
        ''',
        color=discord.Color.green()
    )
    await message.channel.send(embed=embed)

elif message.content.lower().startswith(("magical resist food buff", "magical resist buff")):
    embed = discord.Embed(
        title='Magical Resist Food Buff Codes',
        description='''
1. Code: 1010004 LVL 10
2. Code: 4080087 LVL 9
3. Code: 7222227 LVL 9
4. Address: Sofya - Ward A- 69
        ''',
        color=discord.Color.green()
    )
    await message.channel.send(embed=embed)

elif message.content.lower().startswith(("physical resist food buff", "physical resist buff")):
    embed = discord.Embed(
        title='Physical Resist Food Buff Codes',
        description='''
1. Code: 1020001 LVL 10
2. Code: 6010701 LVL 9
3. Code: 1100000 LVL 9
        ''',
        color=discord.Color.green()
    )
    await message.channel.send(embed=embed)

elif message.content.lower().startswith(("fractional barrier food buff", "fractional barrier buff")):
    embed = discord.Embed(
        title='Fractional Barrier Food Buff Codes',
        description='''
1. Code: 1012222 LVL 10
2. Code: 2202202 LVL 9
        ''',
        color=discord.Color.green()
    )
    await message.channel.send(embed=embed)

elif message.content.lower().startswith(("+aggro food buff", "+aggro buff")):
    embed = discord.Embed(
        title='+Aggro% Food Buff Codes',
        description='''
1. Code: 6260113 LVL 10
2. Code: 3158668 LVL 10
3. Code: 1013000 LVL 9
4. Code: 1010207 LVL 9
5. Code: 7171717 LVL 9
        ''',
        color=discord.Color.green()
    )
    await message.channel.send(embed=embed)
    ...
    embed = discord.Embed(
        title='-Aggro% Food Buff Codes',
        description='''
1. Code: 1010038 LVL 10
2. Code: 1011174 LVL 10
3. Address: Sofya-A-2 LVL 10
4. Code: 3061206 LVL 8
5. Code: 2110000 LVL 8
        ''',
        color=discord.Color.green()
    )
    await message.channel.send(embed=embed)

elif message.content.lower().startswith(("drop rate food buff", "drop rate buff")):
    embed = discord.Embed(
        title='Drop Rate Food Buff Codes',
        description='''
1. Code: 4196969 LVL 6
2. Code: 7057777 LVL 6
        ''',
        color=discord.Color.green()
    )
    await message.channel.send(embed=embed)
